...
gradBoost=joblib.load('/home/niharika/Desktop/4_2/RR/Hydrological_Modelling/Final_Hydro/Model_Codes/model_files/GradientBoost.sav')


class GradientBoost(SelectPage):
    def __init__(self, parent, controller):
        ...
        self.label_name=tk.Label(self, text ="Gradient Boost", font = Vars.LARGE_FONT,bg='cyan')
    ...
    def _calculate_csv_output(self):
        ...
        if inputFilename == "" or outputFilename == "":
            ...
            y_pred=self.scalery.inverse_transform((gradBoost.predict(self.scalerx.transform(data))))           
    ...
    def vec_predict(self):
        ...
        if validate:
            ...
            #Predict it
            y_pred=self.scalery.inverse_transform(gradBoost.predict(self.scalerx.transform(vec)))
