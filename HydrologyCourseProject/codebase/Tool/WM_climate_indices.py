...
def climate_indices_max(index = 'SPI', dataset_name = 'data/GLDAS2.0_TP_global.nc', bounding_box = [23,48,3,15], scales = 6, dataset_type = "GLDAS", fig = True, dynamic_name = False, distribution = 'gamma',):
