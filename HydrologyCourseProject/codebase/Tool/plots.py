...
x=pd.read_csv('plot_test.csv')['year']
# Define the date format

y=pd.read_csv('plot_gd.csv')['ro']

y_dt=pd.read_csv('sdt.csv')['ro']
y_gbr=pd.read_csv('sgb.csv')['ro']
y_lin_1=pd.read_csv('slin_1.csv')['ro']
y_lin_2=pd.read_csv('slin_2.csv')['ro']
y_lin_3=pd.read_csv('slin_3.csv')['ro']
y_svr_rbf=pd.read_csv('svr_rbf.csv')['ro']
y_svr_lin=pd.read_csv('svr_lin.csv')['ro']
y_svr_poly=pd.read_csv('svr_poly.csv')['ro']
y_nnet=pd.read_csv('snn.csv')['ro']
